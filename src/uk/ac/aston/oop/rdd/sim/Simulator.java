...
public class Simulator {
	...
	public void act() {
		...
		for (Actor a : new ArrayList<>(field.getContents())) {
			if(a instanceof CountAwareActor) {
				CountAwareActor caa = (CountAwareActor) a;
				caa.setActorCount(Rabbit.class, field.getCount(Rabbit.class));
			}
			a.act(rnd);
		}
	}
